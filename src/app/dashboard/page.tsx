...
const RevenueChart  = dynamic(() => import('@/components/dashboard/DashboardCharts').then(m => m.RevenueChart),  { ssr: false });
const StatusPieChart = dynamic(() => import('@/components/dashboard/DashboardCharts').then(m => m.StatusPieChart), { ssr: false });
const CategoryChart  = dynamic(() => import('@/components/dashboard/DashboardCharts').then(m => m.CategoryChart),  { ssr: false });
